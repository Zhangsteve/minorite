...
<?php if (arg(0) == 'media' && arg(1) == 'asset' && is_numeric(arg(2))): /* A media asset is displayed in a fancybox, we don't need anything else*/?>
  <?php print render($page['content']); ?>
<?php else: /* All other media pages include all page elements */ ?>
  <noscript>
  ...
  <div id="main-layout" class="site-width-setter">
    ...
    <?php print render($page['header']); ?> <!--Page header-->

    <?php print render($page['navigation']); ?> <!--Page nav-->
    ...
    <div id="content" role="main">
      ...
      <div class="contentcol col-retractable rw">
        ...
        <div class="w-2">
          <article class="article album-dataitem-wrapper">
            <?php print dlp_asset_gallery_view_all_albums_link(); ?>
            ...
            <?php if (!empty($tabs['#primary'])): ?><div class="tabs"><?php render($tabs); ?></div><?php endif; ?>
